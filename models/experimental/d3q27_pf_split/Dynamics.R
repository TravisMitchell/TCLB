...
########INPUTS - FLUID########
##############################
	AddSetting(name="fixed_iterator", default=2, comment='how many time to iterate for calculation of viscous force')
	AddSetting(name="gravity_ramp_its", default=0, comment='ramp iterations to increase gravity load')
	AddSetting(name="toroid_shifter", default=1, comment='1:perturb top half of toroid, 0:dont perturb')
