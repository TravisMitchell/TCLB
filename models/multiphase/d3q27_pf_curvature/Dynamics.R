...
AddDensity( name="g0", dx= 0, dy= 0, dz= 0, group="g") ; AddField( name="g0" , group="g")
AddDensity( name="g1", dx= 1, dy= 0, dz= 0, group="g") ; AddField( name="g1" , group="g")
AddDensity( name="g2", dx=-1, dy= 0, dz= 0, group="g") ; AddField( name="g2" , group="g")
AddDensity( name="g3", dx= 0, dy= 1, dz= 0, group="g") ; AddField( name="g3" , group="g")
AddDensity( name="g4", dx= 0, dy=-1, dz= 0, group="g") ; AddField( name="g4" , group="g")
AddDensity( name="g5", dx= 0, dy= 0, dz= 1, group="g") ; AddField( name="g5" , group="g")
AddDensity( name="g6", dx= 0, dy= 0, dz=-1, group="g") ; AddField( name="g6" , group="g")
AddDensity( name="g7", dx= 1, dy= 1, dz= 1, group="g") ; AddField( name="g7" , group="g")
AddDensity( name="g8", dx=-1, dy= 1, dz= 1, group="g") ; AddField( name="g8" , group="g")
AddDensity( name="g9", dx= 1, dy=-1, dz= 1, group="g") ; AddField( name="g9" , group="g")
AddDensity( name="g10",dx=-1, dy=-1, dz= 1, group="g") ; AddField( name="g10", group="g")
AddDensity( name="g11",dx= 1, dy= 1, dz=-1, group="g") ; AddField( name="g11", group="g")
AddDensity( name="g12",dx=-1, dy= 1, dz=-1, group="g") ; AddField( name="g12", group="g")
AddDensity( name="g13",dx= 1, dy=-1, dz=-1, group="g") ; AddField( name="g13", group="g")
AddDensity( name="g14",dx=-1, dy=-1, dz=-1, group="g") ; AddField( name="g14", group="g")
AddDensity( name="g15",dx= 1, dy= 1, dz= 0, group="g") ; AddField( name="g15", group="g")
AddDensity( name="g16",dx=-1, dy= 1, dz= 0, group="g") ; AddField( name="g16", group="g")
AddDensity( name="g17",dx= 1, dy=-1, dz= 0, group="g") ; AddField( name="g17", group="g")
AddDensity( name="g18",dx=-1, dy=-1, dz= 0, group="g") ; AddField( name="g18", group="g")
AddDensity( name="g19",dx= 1, dy= 0, dz= 1, group="g") ; AddField( name="g19", group="g")
AddDensity( name="g20",dx=-1, dy= 0, dz= 1, group="g") ; AddField( name="g20", group="g")
AddDensity( name="g21",dx= 1, dy= 0, dz=-1, group="g") ; AddField( name="g21", group="g")
AddDensity( name="g22",dx=-1, dy= 0, dz=-1, group="g") ; AddField( name="g22", group="g")
AddDensity( name="g23",dx= 0, dy= 1, dz= 1, group="g") ; AddField( name="g23", group="g")
AddDensity( name="g24",dx= 0, dy=-1, dz= 1, group="g") ; AddField( name="g24", group="g")
AddDensity( name="g25",dx= 0, dy= 1, dz=-1, group="g") ; AddField( name="g25", group="g")
AddDensity( name="g26",dx= 0, dy=-1, dz=-1, group="g") ; AddField( name="g26", group="g")

#	Phase Field Evolution d3q15:
AddDensity( name="h0", dx= 0, dy= 0, dz= 0, group="h") ; AddField( name="h0", group="h")
AddDensity( name="h1", dx= 1, dy= 0, dz= 0, group="h") ; AddField( name="h1", group="h")
AddDensity( name="h2", dx=-1, dy= 0, dz= 0, group="h") ; AddField( name="h2", group="h")
AddDensity( name="h3", dx= 0, dy= 1, dz= 0, group="h") ; AddField( name="h3", group="h")
AddDensity( name="h4", dx= 0, dy=-1, dz= 0, group="h") ; AddField( name="h4", group="h")
AddDensity( name="h5", dx= 0, dy= 0, dz= 1, group="h") ; AddField( name="h5", group="h")
AddDensity( name="h6", dx= 0, dy= 0, dz=-1, group="h") ; AddField( name="h6", group="h")
AddDensity( name="h7", dx= 1, dy= 1, dz= 1, group="h") ; AddField( name="h7", group="h")
AddDensity( name="h8", dx=-1, dy= 1, dz= 1, group="h") ; AddField( name="h8", group="h")
AddDensity( name="h9", dx= 1, dy=-1, dz= 1, group="h") ; AddField( name="h9", group="h")
AddDensity( name="h10",dx=-1, dy=-1, dz= 1, group="h") ; AddField( name="h10",group="h")
AddDensity( name="h11",dx= 1, dy= 1, dz=-1, group="h") ; AddField( name="h11",group="h")
AddDensity( name="h12",dx=-1, dy= 1, dz=-1, group="h") ; AddField( name="h12",group="h")
AddDensity( name="h13",dx= 1, dy=-1, dz=-1, group="h") ; AddField( name="h13",group="h")
AddDensity( name="h14",dx=-1, dy=-1, dz=-1, group="h") ; AddField( name="h14",group="h")
...
AddDensity("npx", dx=0, dy=0, dz=0, group="PF")
AddDensity("npy", dx=0, dy=0, dz=0, group="PF")
AddDensity("npz", dx=0, dy=0, dz=0, group="PF")
...
AddField("npx",stencil3d=1, group="PF")
AddField("npy",stencil3d=1, group="PF")
AddField("npz",stencil3d=1, group="PF")
AddField("SurfaceTension",stencil3d=1, group="Thermal")
AddQuantity(name="T",unit="K")
AddQuantity(name="ST",unit="1")
AddQuantity(name="NPhi",unit="1",vector=T)
...
AddStage("RK_1", "TempUpdate1", save=Fields$name=="RK1")
AddStage("RK_2", "TempUpdate2", save=Fields$name=="RK2", load=DensityAll$name=="RK1")
AddStage("RK_3", "TempUpdate3", save=Fields$name=="RK3", load=DensityAll$name %in% c("RK1","RK2"))
AddStage("RK_4", "TempUpdate4", save=Fields$name %in% c("Temp","npx","npy","npx","SurfaceTension"), load=DensityAll$name %in% c("RK1","RK2","RK3"))
...
if (Options$OutFlow){
    ...
    AddStage("calcPhase" , "calcPhaseF",	     save=Fields$group %in% c("PF","Thermal"), 
    ...
    AddStage("BaseInit"  , "Init_distributions", save=Fields$group %in% c("g","h","Vel","PF","Thermal"))
