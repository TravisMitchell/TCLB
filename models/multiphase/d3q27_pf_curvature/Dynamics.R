...
AddStage("RK_1", "TempUpdate1", save=Fields$group %in% c("Thermal","PF"), load=DensityAll$group %in% c("Vel","nw","PF","Thermal"))
AddStage("RK_2", "TempUpdate2", save=Fields$group %in% c("Thermal","PF"), load=DensityAll$group %in% c("Vel","nw","PF","Thermal"))
AddStage("RK_3", "TempUpdate3", save=Fields$group %in% c("Thermal","PF"), load=DensityAll$group %in% c("Vel","nw","PF","Thermal"))
AddStage("RK_4", "TempUpdate4", save=Fields$group %in% c("Thermal","PF"), load=DensityAll$group %in% c("Vel","nw","PF","Thermal"))
AddAction("TempToSteadyState", c("RK_1", "RK_2", "RK_3", "RK_4"))
...
if (Options$OutFlow){
    ...
    AddStage("calcPhase" , "calcPhaseF",	     save=Fields$group %in% c("PF","Thermal"), 
					                             load=DensityAll$group %in% c("g","h","Vel","nw","PF") )
